...
# %%
# fixing issues with proj_create_from database: Cannot find proj.db
# manually set the path to point to the system installation
...
# %%
# sort by icell in ascending order
...
# %%
# keep only icells that intersect with Ireland's boundary
