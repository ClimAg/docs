...
# # ModVege results - HiResIreland - Difference in standard deviation - historical and observational (MERA)
...
for season in season_list:
    ...
    plot_all(
        ...
        var="gro",
        season=season,
        levels=[-45 + 3.6 * n for n in range(26)],
        ticks=[-45 + 15 * n for n in range(7)],
    )
...
for season in season_list:
    ...
    plot_all(
        ...
        var="pgro",
        season=season,
        levels=[-75 + 6 * n for n in range(26)],
...
for season in season_list:
    ...
    plot_all(
        ...
        var="c_bm",
        season=season,
        levels=[-9 + 0.72 * n for n in range(26)],
        ticks=[-9 + 3 * n for n in range(7)],
    )
...
for season in season_list:
    ...
    plot_all(
        ...
        var="abs",
        season=season,
        levels=[-18 + 1.44 * n for n in range(26)],
        ticks=[-18 + 6 * n for n in range(7)],
    )
...
plot_all(
    ...
    var="h_bm",
    season=None,
    levels=[-600 + 48 * n for n in range(26)],
    ticks=[-600 + 200 * n for n in range(7)],
)
