...
gdal_translate -of GTiff \
    ...
    "data/climatic-regions/holden_brereton_2004_regions.png" \
    "/tmp/holden_brereton_2004_regions.png"
gdalwarp -r cubic -order 1 -co COMPRESS=  -t_srs EPSG:2157 \
    "/tmp/holden_brereton_2004_regions.png" \
    "data/climatic-regions/holden_brereton_2004_regions.tif"
